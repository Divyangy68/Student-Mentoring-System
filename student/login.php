...
<!--                             <input type="checkbox" name="rememberme" id="rememberme" class="filled-in chk-col-pink">
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        $sql = "select * from student where email='$email' and password='$pswd'";
                        ...
                        if (mysqli_num_rows($result) > 0) 
                        {
                            ...
                            if($row['password']=='changeme')
                            {
                                ...
                                $_SESSION['student_rollno']=$row['rollno'];
                                $_SESSION['student_mentor']=$row['mentor'];
                                $_SESSION['profileset']=$row['profileset'];
                            ...
                            else
                            {
                                $_SESSION['student_email']=$row['email'];
                                $_SESSION['student_rollno']=$row['rollno'];
                                $_SESSION['student_mentor']=$row['mentor_id'];
                                $_SESSION['profileset']=$row['profileset'];
                                
                                if($_SESSION['profileset']==0)
                                {
