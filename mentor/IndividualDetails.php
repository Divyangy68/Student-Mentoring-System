...
<!-- Advanced Form Example With Validation -->
            <div class="row clearfix" style="padding-top: 1%;">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">                                                   
                            <fieldset>                               
                            	<div class="row clearfix">
                            		<div class="col-md-3">
                            			<img id="blah" style="padding-left: 20%;" height="100px" width="200px" class="img-square"  src="data:image/jpeg;base64,<?php echo base64_encode($row1['image']);?>"/>
                            		</div>
                            		<div class="col-md-3">
                        ...
                        <a href="StudentDetails.php" style="padding-left: 45%;"><button type="button" class="btn btn-primary btn-lg m-l-15 waves-effect">Back</button></a><br><br>
                    </div>
                </div>
            </div>
