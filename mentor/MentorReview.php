...
<!-- Advanced Form Example With Validation -->
                ...
                <div class="col-xs-7 col-sm-12 col-md-8 col-lg-9">
                    <div class="card">
                        <div class="header">
                            <h2><center>Submitted Review Status</center></h2>
                        </div>
                        <div class="body">
                                ...
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM student where studentreview='1' AND mentorreview='0' AND mentor_id='$id'";
                                        ...
                                        <tr>                                            
                                            ...
                                            <td><center><a href="Review.php?emailid=<?php echo $row['email'];?>"><button type="button" class="btn btn-primary btn-lg m-l-15 waves-effect">Mentor's Review</button></a></center></td>
                                        </tr>
                                        <?php
                                                }
                                            } 
